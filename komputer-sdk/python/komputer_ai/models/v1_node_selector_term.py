...
class V1NodeSelectorTerm(BaseModel):
    ...
    V1NodeSelectorTerm
    """ # noqa: E501
    match_expressions: Optional[List[V1NodeSelectorRequirement]] = Field(default=None, description="A list of node selector requirements by node's labels. +optional +listType=atomic", alias="matchExpressions")
    match_fields: Optional[List[V1NodeSelectorRequirement]] = Field(default=None, description="A list of node selector requirements by node's fields. +optional +listType=atomic", alias="matchFields")
