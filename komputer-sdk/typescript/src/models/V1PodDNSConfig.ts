...
import {
    ...
    V1PodDNSConfigOptionToJSONTyped,
...
export function V1PodDNSConfigToJSON(json: any): V1PodDNSConfig {
    return V1PodDNSConfigToJSONTyped(json, false);
}

export function V1PodDNSConfigToJSONTyped(value?: V1PodDNSConfig | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
