...
class MainOfficeListResponse(BaseModel):
    """
    MainOfficeListResponse
    """ # noqa: E501
    offices: Optional[List[MainOfficeResponse]] = None
    __properties: ClassVar[List[str]] = ["offices"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "offices": [MainOfficeResponse.from_dict(_item) for _item in obj["offices"]] if obj.get("offices") is not None else None
        })
        return _obj
