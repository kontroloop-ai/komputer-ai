...
type V1Toleration struct {
	...
	Operator *V1TolerationOperator `json:"operator,omitempty"`
...
// SetEffect gets a reference to the given V1TaintEffect and assigns it to the Effect field.
...
// SetOperator gets a reference to the given V1TolerationOperator and assigns it to the Operator field.
