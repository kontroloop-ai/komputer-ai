...
**Operator** | Pointer to [**V1LabelSelectorOperator**](V1LabelSelectorOperator.md) | operator represents a key&#39;s relationship to a set of values. Valid operators are In, NotIn, Exists and DoesNotExist. | [optional] 
...
`func (o *V1LabelSelectorRequirement) GetOperator() V1LabelSelectorOperator`

GetOperator returns the Operator field if non-nil, zero value otherwise.

### GetOperatorOk

`func (o *V1LabelSelectorRequirement) GetOperatorOk() (*V1LabelSelectorOperator, bool)`
...
`func (o *V1LabelSelectorRequirement) SetOperator(v V1LabelSelectorOperator)`
