...
class V1NodeSelector(BaseModel):
    ...
    V1NodeSelector
    """ # noqa: E501
    node_selector_terms: Optional[List[V1NodeSelectorTerm]] = Field(default=None, description="Required. A list of node selector terms. The terms are ORed. +listType=atomic", alias="nodeSelectorTerms")
