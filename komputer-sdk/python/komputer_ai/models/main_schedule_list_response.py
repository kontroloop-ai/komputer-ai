...
class MainScheduleListResponse(BaseModel):
    """
    MainScheduleListResponse
    """ # noqa: E501
    schedules: Optional[List[MainScheduleResponse]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "schedules": [MainScheduleResponse.from_dict(_item) for _item in obj["schedules"]] if obj.get("schedules") is not None else None
        })
        return _obj
