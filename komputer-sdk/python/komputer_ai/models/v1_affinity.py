...
class V1Affinity(BaseModel):
    ...
    V1Affinity
    """ # noqa: E501
    node_affinity: Optional[V1NodeAffinity] = Field(default=None, description="Describes node affinity scheduling rules for the pod. +optional", alias="nodeAffinity")
    pod_affinity: Optional[V1PodAffinity] = Field(default=None, description="Describes pod affinity scheduling rules (e.g. co-locate this pod in the same node, zone, etc. as some other pod(s)). +optional", alias="podAffinity")
    pod_anti_affinity: Optional[V1PodAntiAffinity] = Field(default=None, description="Describes pod anti-affinity scheduling rules (e.g. avoid putting this pod in the same node, zone, etc. as some other pod(s)). +optional", alias="podAntiAffinity")
