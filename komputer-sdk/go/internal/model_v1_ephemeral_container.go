...
// SetImagePullPolicy gets a reference to the given V1PullPolicy and assigns it to the ImagePullPolicy field.
...
func (o *V1EphemeralContainer) GetRestartPolicy() V1ContainerRestartPolicy {
	if o == nil || IsNil(o.RestartPolicy) {
		var ret V1ContainerRestartPolicy
		return ret
	}
...
// SetRestartPolicy gets a reference to the given V1ContainerRestartPolicy and assigns it to the RestartPolicy field.
...
func (o *V1EphemeralContainer) GetTerminationMessagePolicy() V1TerminationMessagePolicy {
	if o == nil || IsNil(o.TerminationMessagePolicy) {
		var ret V1TerminationMessagePolicy
		return ret
	}
...
// SetTerminationMessagePolicy gets a reference to the given V1TerminationMessagePolicy and assigns it to the TerminationMessagePolicy field.
