...
------------ | ------------- | ------------- | -------------
**CachingMode** | Pointer to [**V1AzureDataDiskCachingMode**](V1AzureDataDiskCachingMode.md) | cachingMode is the Host Caching mode: None, Read Only, Read Write. +optional +default&#x3D;ref(AzureDataDiskCachingReadWrite) | [optional] 
