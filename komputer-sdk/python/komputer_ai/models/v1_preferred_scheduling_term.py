...
class V1PreferredSchedulingTerm(BaseModel):
    ...
    """ # noqa: E501
    preference: Optional[V1NodeSelectorTerm] = Field(default=None, description="A node selector term, associated with the corresponding weight.")
    weight: Optional[StrictInt] = Field(default=None, description="Weight associated with matching the corresponding nodeSelectorTerm, in the range 1-100.")
