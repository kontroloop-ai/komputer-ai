...
type V1PodSecurityContext struct {
	...
	FsGroupChangePolicy *V1PodFSGroupChangePolicy `json:"fsGroupChangePolicy,omitempty"`
	...
	SeLinuxChangePolicy *V1PodSELinuxChangePolicy `json:"seLinuxChangePolicy,omitempty"`
	...
	SupplementalGroupsPolicy *V1SupplementalGroupsPolicy `json:"supplementalGroupsPolicy,omitempty"`
...
func (o *V1PodSecurityContext) GetFsGroupChangePolicy() V1PodFSGroupChangePolicy {
	if o == nil || IsNil(o.FsGroupChangePolicy) {
		var ret V1PodFSGroupChangePolicy
		return ret
	}
...
// SetFsGroupChangePolicy gets a reference to the given V1PodFSGroupChangePolicy and assigns it to the FsGroupChangePolicy field.
...
func (o *V1PodSecurityContext) GetSeLinuxChangePolicy() V1PodSELinuxChangePolicy {
	if o == nil || IsNil(o.SeLinuxChangePolicy) {
		var ret V1PodSELinuxChangePolicy
		return ret
	}
...
// SetSeLinuxChangePolicy gets a reference to the given V1PodSELinuxChangePolicy and assigns it to the SeLinuxChangePolicy field.
...
func (o *V1PodSecurityContext) GetSupplementalGroupsPolicy() V1SupplementalGroupsPolicy {
	if o == nil || IsNil(o.SupplementalGroupsPolicy) {
		var ret V1SupplementalGroupsPolicy
		return ret
	}
...
// SetSupplementalGroupsPolicy gets a reference to the given V1SupplementalGroupsPolicy and assigns it to the SupplementalGroupsPolicy field.
