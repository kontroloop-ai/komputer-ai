...
class V1PersistentVolumeClaimVolumeSource(BaseModel):
    ...
    """ # noqa: E501
    claim_name: Optional[StrictStr] = Field(default=None, description="claimName is the name of a PersistentVolumeClaim in the same namespace as the pod using this volume. More info: https://kubernetes.io/docs/concepts/storage/persistent-volumes#persistentvolumeclaims", alias="claimName")
    read_only: Optional[StrictBool] = Field(default=None, description="readOnly Will force the ReadOnly setting in VolumeMounts. Default false. +optional", alias="readOnly")
