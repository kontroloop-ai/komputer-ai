...
class V1HostAlias(BaseModel):
    ...
    V1HostAlias
    """ # noqa: E501
    hostnames: Optional[List[StrictStr]] = Field(default=None, description="Hostnames for the above IP address. +listType=atomic")
    ip: Optional[StrictStr] = Field(default=None, description="IP address of the host file entry. +required")
