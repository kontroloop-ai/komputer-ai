...
class MainCreateScheduleAgentSpec(BaseModel):
    """
    ...
    secret_refs: Optional[List[StrictStr]] = Field(default=None, alias="secretRefs")
    template_ref: Optional[StrictStr] = Field(default=None, alias="templateRef")
    __properties: ClassVar[List[str]] = ["lifecycle", "model", "role", "secretRefs", "templateRef"]
