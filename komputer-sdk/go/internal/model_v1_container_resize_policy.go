...
// SetResourceName gets a reference to the given V1ResourceName and assigns it to the ResourceName field.
...
func (o *V1ContainerResizePolicy) GetRestartPolicy() V1ResourceResizeRestartPolicy {
	if o == nil || IsNil(o.RestartPolicy) {
		var ret V1ResourceResizeRestartPolicy
		return ret
	}
...
// SetRestartPolicy gets a reference to the given V1ResourceResizeRestartPolicy and assigns it to the RestartPolicy field.
