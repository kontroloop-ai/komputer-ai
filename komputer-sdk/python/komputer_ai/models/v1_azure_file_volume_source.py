...
class V1AzureFileVolumeSource(BaseModel):
    ...
    secret_name: Optional[StrictStr] = Field(default=None, description="secretName is the  name of secret that contains Azure Storage Account Name and Key", alias="secretName")
    share_name: Optional[StrictStr] = Field(default=None, description="shareName is the azure share Name", alias="shareName")
