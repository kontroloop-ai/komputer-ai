...
class V1EphemeralContainer(BaseModel):
    ...
    lifecycle: Optional[V1Lifecycle] = Field(default=None, description="Lifecycle is not allowed for ephemeral containers. +optional")
    liveness_probe: Optional[V1Probe] = Field(default=None, description="Probes are not allowed for ephemeral containers. +optional", alias="livenessProbe")
    name: Optional[StrictStr] = Field(default=None, description="Name of the ephemeral container specified as a DNS_LABEL. This name must be unique among all containers, init containers and ephemeral containers.")
    ports: Optional[List[V1ContainerPort]] = Field(default=None, description="Ports are not allowed for ephemeral containers. +optional +patchMergeKey=containerPort +patchStrategy=merge +listType=map +listMapKey=containerPort +listMapKey=protocol")
    readiness_probe: Optional[V1Probe] = Field(default=None, description="Probes are not allowed for ephemeral containers. +optional", alias="readinessProbe")
    ...
    resources: Optional[V1ResourceRequirements] = Field(default=None, description="Resources are not allowed for ephemeral containers. Ephemeral containers use spare resources already allocated to the pod. +optional")
    restart_policy: Optional[V1ContainerRestartPolicy] = Field(default=None, description="Restart policy for the container to manage the restart behavior of each container within a pod. You cannot set this field on ephemeral containers. +optional", alias="restartPolicy")
    restart_policy_rules: Optional[List[V1ContainerRestartRule]] = Field(default=None, description="Represents a list of rules to be checked to determine if the container should be restarted on exit. You cannot set this field on ephemeral containers. +featureGate=ContainerRestartRules +optional +listType=atomic", alias="restartPolicyRules")
    security_context: Optional[V1SecurityContext] = Field(default=None, description="Optional: SecurityContext defines the security options the ephemeral container should be run with. If set, the fields of SecurityContext override the equivalent fields of PodSecurityContext. +optional", alias="securityContext")
    startup_probe: Optional[V1Probe] = Field(default=None, description="Probes are not allowed for ephemeral containers. +optional", alias="startupProbe")
    ...
    target_container_name: Optional[StrictStr] = Field(default=None, description="If set, the name of the container from PodSpec that this ephemeral container targets. The ephemeral container will be run in the namespaces (IPC, PID, etc) of this container. If not set then the ephemeral container uses the namespaces configured in the Pod spec.  The container runtime must implement support for this feature. If the runtime does not support namespace targeting then the result of setting this field is undefined. +optional", alias="targetContainerName")
    ...
    volume_mounts: Optional[List[V1VolumeMount]] = Field(default=None, description="Pod volumes to mount into the container's filesystem. Subpath mounts are not allowed for ephemeral containers. Cannot be updated. +optional +patchMergeKey=mountPath +patchStrategy=merge +listType=map +listMapKey=mountPath", alias="volumeMounts")
