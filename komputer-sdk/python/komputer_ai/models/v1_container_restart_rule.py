...
class V1ContainerRestartRule(BaseModel):
    ...
    """ # noqa: E501
    action: Optional[V1ContainerRestartRuleAction] = Field(default=None, description="Specifies the action taken on a container exit if the requirements are satisfied. The only possible value is \"Restart\" to restart the container. +required")
    exit_codes: Optional[V1ContainerRestartRuleOnExitCodes] = Field(default=None, description="Represents the exit codes to check on container exits. +optional +oneOf=when", alias="exitCodes")
