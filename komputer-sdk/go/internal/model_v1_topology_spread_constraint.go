...
type V1TopologySpreadConstraint struct {
	// LabelSelector is used to find matching pods. Pods that match this label selector are counted to determine the number of pods in their corresponding topology do +optional
	...
	NodeAffinityPolicy *V1NodeInclusionPolicy `json:"nodeAffinityPolicy,omitempty"`
	...
	NodeTaintsPolicy *V1NodeInclusionPolicy `json:"nodeTaintsPolicy,omitempty"`
	...
	WhenUnsatisfiable *V1UnsatisfiableConstraintAction `json:"whenUnsatisfiable,omitempty"`
}
...
// SetNodeAffinityPolicy gets a reference to the given V1NodeInclusionPolicy and assigns it to the NodeAffinityPolicy field.
...
// SetNodeTaintsPolicy gets a reference to the given V1NodeInclusionPolicy and assigns it to the NodeTaintsPolicy field.
...
func (o *V1TopologySpreadConstraint) GetWhenUnsatisfiable() V1UnsatisfiableConstraintAction {
	if o == nil || IsNil(o.WhenUnsatisfiable) {
		var ret V1UnsatisfiableConstraintAction
		return ret
	}
...
// SetWhenUnsatisfiable gets a reference to the given V1UnsatisfiableConstraintAction and assigns it to the WhenUnsatisfiable field.
