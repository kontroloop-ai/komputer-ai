...
type V1LabelSelectorRequirement struct {
	...
	Operator *V1LabelSelectorOperator `json:"operator,omitempty"`
...
func (o *V1LabelSelectorRequirement) GetOperator() V1LabelSelectorOperator {
	if o == nil || IsNil(o.Operator) {
		var ret V1LabelSelectorOperator
		return ret
	}
	return *o.Operator
}
...
// SetOperator gets a reference to the given V1LabelSelectorOperator and assigns it to the Operator field.
