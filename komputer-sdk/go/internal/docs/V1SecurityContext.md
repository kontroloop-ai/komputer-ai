...
**ProcMount** | Pointer to [**V1ProcMountType**](V1ProcMountType.md) | procMount denotes the type of proc mount to use for the containers. The default value is Default which uses the container runtime defaults for readonly paths and masked paths. This requires the ProcMountType feature flag to be enabled. Note that this field cannot be set when spec.os.name is windows. +optional | [optional] 
...
`func (o *V1SecurityContext) GetProcMount() V1ProcMountType`

GetProcMount returns the ProcMount field if non-nil, zero value otherwise.

### GetProcMountOk

`func (o *V1SecurityContext) GetProcMountOk() (*V1ProcMountType, bool)`
...
`func (o *V1SecurityContext) SetProcMount(v V1ProcMountType)`
