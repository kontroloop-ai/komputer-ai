...
class MainSecretListResponse(BaseModel):
    """
    MainSecretListResponse
    """ # noqa: E501
    secrets: Optional[List[MainSecretResponse]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "secrets": [MainSecretResponse.from_dict(_item) for _item in obj["secrets"]] if obj.get("secrets") is not None else None
        })
        return _obj
