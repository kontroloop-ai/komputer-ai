...
// SetPort gets a reference to the given IntstrIntOrString and assigns it to the Port field.
...
// SetScheme gets a reference to the given V1URIScheme and assigns it to the Scheme field.
