...
import {
    ...
    V1ManagedFieldsEntryToJSONTyped,
...
export function V1ObjectMetaToJSON(json: any): V1ObjectMeta {
    return V1ObjectMetaToJSONTyped(json, false);
}

export function V1ObjectMetaToJSONTyped(value?: V1ObjectMeta | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
