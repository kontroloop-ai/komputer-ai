...
class V1PodReadinessGate(BaseModel):
    ...
    V1PodReadinessGate
    """ # noqa: E501
    condition_type: Optional[V1PodConditionType] = Field(default=None, description="ConditionType refers to a condition in the pod's condition list with matching type.", alias="conditionType")
