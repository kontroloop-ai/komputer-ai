...
export function V1ConfigMapProjectionToJSON(json: any): V1ConfigMapProjection {
    return V1ConfigMapProjectionToJSONTyped(json, false);
}

export function V1ConfigMapProjectionToJSONTyped(value?: V1ConfigMapProjection | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
