...
export function V1TypedLocalObjectReferenceToJSON(json: any): V1TypedLocalObjectReference {
    return V1TypedLocalObjectReferenceToJSONTyped(json, false);
}

export function V1TypedLocalObjectReferenceToJSONTyped(value?: V1TypedLocalObjectReference | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
