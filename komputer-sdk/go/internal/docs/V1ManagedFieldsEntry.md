...
**FieldsV1** | Pointer to **map[string]interface{}** | FieldsV1 holds the first JSON version format as described in the \&quot;FieldsV1\&quot; type. +optional | [optional] 
**Manager** | Pointer to **string** | Manager is an identifier of the workflow managing these fields. | [optional] 
**Operation** | Pointer to [**V1ManagedFieldsOperationType**](V1ManagedFieldsOperationType.md) | Operation is the type of operation which lead to this ManagedFieldsEntry being created. The only valid values for this field are &#39;Apply&#39; and &#39;Update&#39;. | [optional] 
...
`func (o *V1ManagedFieldsEntry) GetOperation() V1ManagedFieldsOperationType`

GetOperation returns the Operation field if non-nil, zero value otherwise.

### GetOperationOk

`func (o *V1ManagedFieldsEntry) GetOperationOk() (*V1ManagedFieldsOperationType, bool)`
...
`func (o *V1ManagedFieldsEntry) SetOperation(v V1ManagedFieldsOperationType)`
