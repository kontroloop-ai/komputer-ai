...
class V1Sysctl(BaseModel):
    ...
    V1Sysctl
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Name of a property to set")
    value: Optional[StrictStr] = Field(default=None, description="Value of a property to set")
