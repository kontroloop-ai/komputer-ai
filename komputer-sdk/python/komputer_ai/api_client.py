...
from komputer_ai.configuration import Configuration
from komputer_ai.api_response import ApiResponse, T as ApiResponseT
import komputer_ai.models
from komputer_ai import rest
from komputer_ai.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(komputer_ai.models, klass)
