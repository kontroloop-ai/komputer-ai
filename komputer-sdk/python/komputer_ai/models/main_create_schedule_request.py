...
class MainCreateScheduleRequest(BaseModel):
    """
    MainCreateScheduleRequest
    """ # noqa: E501
    agent: Optional[MainCreateScheduleAgentSpec] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "agent": MainCreateScheduleAgentSpec.from_dict(obj["agent"]) if obj.get("agent") is not None else None,
