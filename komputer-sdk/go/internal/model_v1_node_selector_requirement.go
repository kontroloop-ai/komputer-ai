...
type V1NodeSelectorRequirement struct {
	...
	Operator *V1NodeSelectorOperator `json:"operator,omitempty"`
...
func (o *V1NodeSelectorRequirement) GetOperator() V1NodeSelectorOperator {
	if o == nil || IsNil(o.Operator) {
		var ret V1NodeSelectorOperator
		return ret
	}
	return *o.Operator
}
...
// SetOperator gets a reference to the given V1NodeSelectorOperator and assigns it to the Operator field.
