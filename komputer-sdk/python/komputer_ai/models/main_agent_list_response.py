...
class MainAgentListResponse(BaseModel):
    """
    MainAgentListResponse
    """ # noqa: E501
    agents: Optional[List[MainAgentResponse]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "agents": [MainAgentResponse.from_dict(_item) for _item in obj["agents"]] if obj.get("agents") is not None else None
        })
        return _obj
