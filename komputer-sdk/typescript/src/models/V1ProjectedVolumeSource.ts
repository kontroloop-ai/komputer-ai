...
export function V1ProjectedVolumeSourceToJSON(json: any): V1ProjectedVolumeSource {
    return V1ProjectedVolumeSourceToJSONTyped(json, false);
}

export function V1ProjectedVolumeSourceToJSONTyped(value?: V1ProjectedVolumeSource | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
