...
export function V1TypedObjectReferenceToJSON(json: any): V1TypedObjectReference {
    return V1TypedObjectReferenceToJSONTyped(json, false);
}

export function V1TypedObjectReferenceToJSONTyped(value?: V1TypedObjectReference | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
