...
class V1EnvVarSource(BaseModel):
    ...
    file_key_ref: Optional[V1FileKeySelector] = Field(default=None, description="FileKeyRef selects a key of the env file. Requires the EnvFiles feature gate to be enabled.  +featureGate=EnvFiles +optional", alias="fileKeyRef")
