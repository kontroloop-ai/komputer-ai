...
export function V1SecretKeySelectorToJSON(json: any): V1SecretKeySelector {
    return V1SecretKeySelectorToJSONTyped(json, false);
}

export function V1SecretKeySelectorToJSONTyped(value?: V1SecretKeySelector | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
