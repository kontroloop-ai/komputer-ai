...
func (o *V1VolumeMount) GetRecursiveReadOnly() V1RecursiveReadOnlyMode {
	if o == nil || IsNil(o.RecursiveReadOnly) {
		var ret V1RecursiveReadOnlyMode
		return ret
	}
...
// SetRecursiveReadOnly gets a reference to the given V1RecursiveReadOnlyMode and assigns it to the RecursiveReadOnly field.
