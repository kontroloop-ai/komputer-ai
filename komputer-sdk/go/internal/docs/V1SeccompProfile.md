...
**Type** | Pointer to [**V1SeccompProfileType**](V1SeccompProfileType.md) | type indicates which kind of seccomp profile will be applied. Valid options are:  Localhost - a profile defined in a file on the node should be used. RuntimeDefault - the container runtime default profile should be used. Unconfined - no profile should be applied. +unionDiscriminator | [optional] 
...
`func (o *V1SeccompProfile) GetType() V1SeccompProfileType`

GetType returns the Type field if non-nil, zero value otherwise.

### GetTypeOk

`func (o *V1SeccompProfile) GetTypeOk() (*V1SeccompProfileType, bool)`
...
`func (o *V1SeccompProfile) SetType(v V1SeccompProfileType)`
