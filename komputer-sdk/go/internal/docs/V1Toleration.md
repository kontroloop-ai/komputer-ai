...
------------ | ------------- | ------------- | -------------
**Effect** | Pointer to [**V1TaintEffect**](V1TaintEffect.md) | Effect indicates the taint effect to match. Empty means match all taint effects. When specified, allowed values are NoSchedule, PreferNoSchedule and NoExecute. +optional | [optional] 
...
**Operator** | Pointer to [**V1TolerationOperator**](V1TolerationOperator.md) | Operator represents a key&#39;s relationship to the value. Valid operators are Exists, Equal, Lt, and Gt. Defaults to Equal. Exists is equivalent to wildcard for value, so that a pod can tolerate all taints of a particular category. Lt and Gt perform numeric comparisons (requires feature gate TaintTolerationComparisonOperators). +optional | [optional] 
...
`func (o *V1Toleration) GetEffect() V1TaintEffect`

GetEffect returns the Effect field if non-nil, zero value otherwise.

### GetEffectOk

`func (o *V1Toleration) GetEffectOk() (*V1TaintEffect, bool)`
...
`func (o *V1Toleration) SetEffect(v V1TaintEffect)`
...
`func (o *V1Toleration) GetOperator() V1TolerationOperator`

GetOperator returns the Operator field if non-nil, zero value otherwise.

### GetOperatorOk

`func (o *V1Toleration) GetOperatorOk() (*V1TolerationOperator, bool)`
...
`func (o *V1Toleration) SetOperator(v V1TolerationOperator)`
