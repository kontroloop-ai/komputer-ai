...
type V1PodReadinessGate struct {
	...
	ConditionType *V1PodConditionType `json:"conditionType,omitempty"`
}
...
// SetConditionType gets a reference to the given V1PodConditionType and assigns it to the ConditionType field.
